...
var require_react_dom_client_development = __commonJS({
  "node_modules/react-dom/cjs/react-dom-client.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var Scheduler = require_scheduler(), React4 = require_react(), ReactDOM2 = require_react_dom(), REACT_LEGACY_ELEMENT_TYPE = Symbol.for("react.element"), REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler"), REACT_PROVIDER_TYPE = Symbol.for("react.provider"), REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy");
...
var JunQiBoard = ({
  ...
  const [board, setBoard] = (0, import_react.useState)(Array(12).fill(null).map(() => Array(5).fill(null)));
  ...
  function updatePiece(updates) {
    ...
    for (let i = 0; i < n; i++) {
      ...
      newBoard = newBoard.map(
        (rowArray, j) => j === row ? rowArray.map((cell, k) => k === col ? update_piece : cell) : rowArray
      );
    }
    setBoard(newBoard);
  }
...
// src/App.tsx
var App = () => {
  return /* @__PURE__ */ import_react2.default.createElement("div", { style: { textAlign: "center", marginTop: "50px" } }, /* @__PURE__ */ import_react2.default.createElement("h1", null, "Junqi Demo"), /* @__PURE__ */ import_react2.default.createElement(JunQiBoard_default, null));
};
var App_default = App;

// src/index.tsx
var root = import_client.default.createRoot(
  document.getElementById("junqi-app")
);
root.render(
