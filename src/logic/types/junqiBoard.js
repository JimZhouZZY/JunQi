...
class JunqiBoard extends JunqiGraph {
    constructor() {
        super(); 
        this.rows = 12;
        this.cols = 5
    ...
    init() {
        ...
        this.addNode(node("2-0", 'railway')); this.addNode(node("8-0", 'railway')); this.addNode(node("4-4", 'railway'));
        this.addNode(node("3-0", 'railway')); this.addNode(node("9-0", 'railway')); this.addNode(node("7-4", 'railway'));
        this.addNode(node("4-0", 'railway')); this.addNode(node("2-4", 'railway')); this.addNode(node("8-4", 'railway'));
        ...
        for (let i = 0; i < 4; i++) {
            ...
            this.addEdge(node("10-"+str1, 'railway'), node("10-"+str2, 'railway'));
        }
        for (let j = 1; j < 10; j++) {
